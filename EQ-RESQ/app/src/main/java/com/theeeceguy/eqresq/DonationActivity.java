...
public class DonationActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    String amountText, spinnerText, finalMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarDonation);
        ...
        String[] items = new String[]{"Taka (BDT)", "Dollar ($)"};
        ...
        donate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                amountText = donationAmount.getText().toString();
                if(amountText.equals("")) {
                    Toast.makeText(getBaseContext(), "Please enter amount before sending.", Toast.LENGTH_LONG).show();
                } else {
                    finalMessage = "Amount: " + amountText + " " + spinnerText + " has been sent.\nThank You!";
                    Toast.makeText(getBaseContext(), finalMessage, Toast.LENGTH_LONG).show();
                }
            }
        });
